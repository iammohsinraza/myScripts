...
img_fol_loc = line[2].split('>')
img_fol_loc = img_fol_loc[1].rstrip()
##
...
browser.get("https://www.olx.com.pk/account/?ref%5B0%5D%5Baction%5D=myaccount&ref%5B0%5D%5Bmethod%5D=index")
time.sleep(4)
browser.find_element_by_xpath('//*[@id="userEmail"]').send_keys(userEmail)
